...
from forms.edit_user_form import UserEditForm
from forms.edit_feature_form import EditFeatureForm
from forms.edit_remedy_form import EditRemedyForm
import uuid
import json
import plotly
...
class OrmFeature(db.Model):
    ...
    formtype = db.Column(db.String(20), nullable=False)
